...
function SearchPage() {
    ...
    if (!city) {
        return <ErrorMessageContainer errorMessage={"Error 404: No City Found :("} />;
    }

    if (!results || results.data.length === 0) {
        return <ErrorMessageContainer errorMessage={`Error 404: No Registered Restaurant found in ${city}. Try a Different City :(`} />;
    }
